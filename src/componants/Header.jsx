    ...
    <>
      ...
      <div className="top-header aspida-max-w bg-white">
        <div className="topp-head flex justify-between items-center gap-4 text-black font-semibold">
          ...
          "><img src="public/image/Socialmedial/gmail_5968534.png" alt="" className="w-[25px]" /><p>info@aspida.com</p> </div>
          <div className="top-header-social flex items-center gap-4">
            <img src="public/image/Socialmedial/facebook_2626269.png" alt="" />
            <img src="public/image/Socialmedial/instagram_2626270.png" alt="" />
            <img src="public/image/Socialmedial/letter-x_5119120.png" alt="" />
            <img src="public/image/Socialmedial/linkedin_4782336.png" alt="" />
          </div>
          <p>
            <GoogleTranslate />
          </p>
